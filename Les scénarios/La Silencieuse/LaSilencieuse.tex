...
\end{flushright} 
Les Gardiens possèdent une force musculaire surprenante. Au nombre de trois, ils tentent de surprendre leurs adversaires en surgissant des ajoncs en en les plaquant au sol, espérant infliger une blessure sérieuse avant de repartir.
\emph{Utilisez pour les Gardiens des profils de Gargouille ou équivalent. Le but est d'infliger plusieurs blessures aux joueurs, mais pas de les mettre en danger mortel.}
